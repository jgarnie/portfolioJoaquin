...
export default function ContactMe() {
  ...
  const [email, setEmail] = useState('');
    ...
    const sendData=()=>{
        ...
        fetch('http://api.joaquingarcia.tech/api/contact',{
            method:'post',
            body:JSON.stringify(
                {email,name,text}
            ),
 ...
 */}
    ...
    {success?
            <section id="contact" className="contact">
                <h2 className="contact__heading">CONTACT ME</h2>
                {field?'':<p className="contact__heading--fail">Please, check the fields and try again</p>}
                ...
                <section id="contact" className="contact">
                    ...
                    <p className="contact__confirm">Thanks for contacting me, check your inbox, you should have received an email, if it is not the case, please reach me on the email address: <span className="contact__email--text">garcia.nieto.joaquin@gmail.com</span> </p>
